...
class PeopleData {
  ...
  public:
    PeopleData(string lastname,string name,string patronymic,
...
class PeopleLinkedList{
  ...
  public:
    ...
    PeopleData* operator [] (unsigned index){
      return getAt(index);
    }
    //SET
    PeopleData* insert(unsigned index,string lastname,string name,string patronymic,
        string post,string address){
